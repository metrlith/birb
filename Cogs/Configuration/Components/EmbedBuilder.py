...
class NoEmbed(discord.ui.View):
    ...
    @discord.ui.button(
        label="Button",
        style=discord.ButtonStyle.blurple,
        emoji="<:Button:1223063359184830494>",
    )
    async def Buttons(
        self, interaction: discord.Interaction, button: discord.ui.Button
    ):
    ...
    @discord.ui.button(
        ...
        emoji="<:Reset:1297957894624510093>",
    )
...
class Embed(discord.ui.View):
    ...
    @discord.ui.button(
        label="Description",
        style=discord.ButtonStyle.blurple,
        emoji="<:description:1223062677572812920> ",
        row=0,
    )
    ...
    @discord.ui.button(
        label="Thumbnail",
        style=discord.ButtonStyle.blurple,
        emoji="<:image:1223062544135094363>",
        row=1,
    )
    ...
    @discord.ui.button(
        label="Image",
        style=discord.ButtonStyle.blurple,
        emoji="<:Image:1223063095417765938> ",
        row=1,
    )
    ...
    @discord.ui.button(
        label="Author",
        style=discord.ButtonStyle.blurple,
        emoji="<:Author:1297956338738925722>",
        row=1,
    )
